...
var pred_loader = document.getElementById("pred_loader");
var model = undefined;
...
async function predict() {
  ...
  if (prediction[0] === 0) {
      predResult.innerHTML = "Biodegradable";

  } else if (prediction[0] === 1) {
      predResult.innerHTML = "Non-Biodegradable";

  } else {
      predResult.innerHTML = "Can't Say!";
  }
  show(predResult)
